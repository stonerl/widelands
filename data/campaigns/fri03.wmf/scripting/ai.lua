...
p2:scenario_ai_set_militarysite_allowed("empire_sentry")
p2:scenario_ai_set_militarysite_allowed("empire_outpost")
p2:scenario_ai_set_militarysite_allowed("empire_tower")
p2:scenario_ai_set_militarysite_allowed("empire_barrier")
p2:scenario_ai_set_militarysite_allowed("empire_fortress")
p2:scenario_ai_set_militarysite_allowed("empire_castle")

p2:scenario_ai_set_trainingsite_allowed("empire_arena")
p2:scenario_ai_set_trainingsite_allowed("empire_colosseum")
p2:scenario_ai_set_trainingsite_allowed("empire_trainingcamp")

p2:scenario_ai_set_productionsite_allowed("empire_well")
p2:scenario_ai_set_productionsite_allowed("empire_fishers_house")
p2:scenario_ai_set_productionsite_allowed("empire_stonemasons_house")
p2:scenario_ai_set_productionsite_allowed("empire_sawmill")
p2:scenario_ai_set_productionsite_allowed("empire_mill")
p2:scenario_ai_set_productionsite_allowed("empire_bakery")
p2:scenario_ai_set_productionsite_allowed("empire_charcoal_kiln")
p2:scenario_ai_set_productionsite_allowed("empire_smelting_works")
p2:scenario_ai_set_productionsite_allowed("empire_toolsmithy")
p2:scenario_ai_set_productionsite_allowed("empire_armorsmithy")
p2:scenario_ai_set_productionsite_allowed("empire_barracks")
p2:scenario_ai_set_productionsite_allowed("empire_donkeyfarm")
p2:scenario_ai_set_productionsite_allowed("empire_farm")
p2:scenario_ai_set_productionsite_allowed("empire_piggery")
p2:scenario_ai_set_productionsite_allowed("empire_sheepfarm")
p2:scenario_ai_set_productionsite_allowed("empire_weaving_mill")
p2:scenario_ai_set_productionsite_allowed("empire_weaponsmithy")

p2:scenario_ai_set_warehouse_allowed("empire_warehouse")
...
p2:scenario_ai_set_ware_preciousness("cloth", 1)
p2:scenario_ai_set_ware_preciousness("planks", 2)
p2:scenario_ai_set_ware_preciousness("marble", 2)
p2:scenario_ai_set_ware_preciousness("marble_column", 4)
p2:scenario_ai_set_ware_preciousness("fish", 1)
p2:scenario_ai_set_ware_preciousness("meat", 2)
p2:scenario_ai_set_ware_preciousness("water", 1)
p2:scenario_ai_set_ware_preciousness("wheat", 2)
p2:scenario_ai_set_ware_preciousness("flour", 1)
p2:scenario_ai_set_ware_preciousness("empire_bread", 2)
p2:scenario_ai_set_ware_preciousness("beer", 1)
p2:scenario_ai_set_ware_preciousness("coal", 4)
p2:scenario_ai_set_ware_preciousness("iron_ore", 3)
p2:scenario_ai_set_ware_preciousness("iron", 4)
p2:scenario_ai_set_ware_preciousness("gold_ore", 5)
p2:scenario_ai_set_ware_preciousness("gold", 6)
p2:scenario_ai_set_ware_preciousness("spear_wooden", 1)
p2:scenario_ai_set_ware_preciousness("spear", 2)
p2:scenario_ai_set_ware_preciousness("spear_advanced", 2)
p2:scenario_ai_set_ware_preciousness("spear_heavy", 1)
p2:scenario_ai_set_ware_preciousness("spear_war", 1)
p2:scenario_ai_set_ware_preciousness("armor_helmet", 1)
p2:scenario_ai_set_ware_preciousness("armor", 2)
p2:scenario_ai_set_ware_preciousness("armor_chain", 1)
p2:scenario_ai_set_ware_preciousness("armor_gilded", 1)

p2:scenario_ai_set_basic_economy("empire_fishers_house", 2, 3)
p2:scenario_ai_set_basic_economy("empire_well", 1, 3)
p2:scenario_ai_set_basic_economy("empire_stonemasons_house", 1, 8)
p2:scenario_ai_set_basic_economy("empire_sawmill", 2, 9)
p2:scenario_ai_set_basic_economy("empire_mill", 1, 4)
p2:scenario_ai_set_basic_economy("empire_bakery", 1, 4)
p2:scenario_ai_set_basic_economy("empire_charcoal_kiln", 3, 7)
p2:scenario_ai_set_basic_economy("empire_smelting_works", 2, 6)
p2:scenario_ai_set_basic_economy("empire_toolsmithy", 1, 5)
p2:scenario_ai_set_basic_economy("empire_armorsmithy", 1, 3)
p2:scenario_ai_set_basic_economy("empire_donkeyfarm", 1, 1)
p2:scenario_ai_set_basic_economy("empire_farm", 2, 4)
p2:scenario_ai_set_basic_economy("empire_sheepfarm", 1, 3)
p2:scenario_ai_set_basic_economy("empire_weaving_mill", 1, 3)
p2:scenario_ai_set_basic_economy("empire_weaponsmithy", 1, 2)
p2:scenario_ai_set_basic_economy("empire_barracks", 1, 2)
p2:scenario_ai_set_basic_economy("empire_trainingcamp", 1, 1)
p2:scenario_ai_set_basic_economy("empire_arena", 1, 1)
p2:scenario_ai_set_basic_economy("empire_outpost", 1, 7)
p2:scenario_ai_set_basic_economy("empire_sentry", 1, 4)

-- =======================================================================
--                                 Player 4
-- =======================================================================

p4:scenario_ai_set_militarysite_allowed("barbarians_sentry")
p4:scenario_ai_set_militarysite_allowed("barbarians_barrier")
p4:scenario_ai_set_militarysite_allowed("barbarians_tower")
p4:scenario_ai_set_militarysite_allowed("barbarians_fortress")
p4:scenario_ai_set_militarysite_allowed("barbarians_citadel")

p4:scenario_ai_set_warehouse_allowed("barbarians_warehouse")

p4:scenario_ai_set_trainingsite_allowed("barbarians_battlearena")
p4:scenario_ai_set_trainingsite_allowed("barbarians_trainingcamp")

p4:scenario_ai_set_productionsite_allowed("barbarians_well")
p4:scenario_ai_set_productionsite_allowed("barbarians_fishers_hut")
p4:scenario_ai_set_productionsite_allowed("barbarians_wood_hardener")
p4:scenario_ai_set_productionsite_allowed("barbarians_reed_yard")
p4:scenario_ai_set_productionsite_allowed("barbarians_lime_kiln")
p4:scenario_ai_set_productionsite_allowed("barbarians_bakery")
p4:scenario_ai_set_productionsite_allowed("barbarians_micro_brewery")
p4:scenario_ai_set_productionsite_allowed("barbarians_brewery")
p4:scenario_ai_set_productionsite_allowed("barbarians_charcoal_kiln")
p4:scenario_ai_set_productionsite_allowed("barbarians_smelting_works")
p4:scenario_ai_set_productionsite_allowed("barbarians_metal_workshop")
p4:scenario_ai_set_productionsite_allowed("barbarians_ax_workshop")
p4:scenario_ai_set_productionsite_allowed("barbarians_warmill")
p4:scenario_ai_set_productionsite_allowed("barbarians_barracks")
p4:scenario_ai_set_productionsite_allowed("barbarians_farm")
p4:scenario_ai_set_productionsite_allowed("barbarians_helmsmithy")
p4:scenario_ai_set_productionsite_allowed("barbarians_cattlefarm")
...
p4:scenario_ai_set_ware_preciousness("blackwood", 3)
p4:scenario_ai_set_ware_preciousness("grout", 3)
p4:scenario_ai_set_ware_preciousness("thatch_reed", 1)
p4:scenario_ai_set_ware_preciousness("fish", 1)
p4:scenario_ai_set_ware_preciousness("water", 1)
p4:scenario_ai_set_ware_preciousness("wheat", 2)
p4:scenario_ai_set_ware_preciousness("barbarians_bread", 3)
p4:scenario_ai_set_ware_preciousness("beer_strong", 1)
p4:scenario_ai_set_ware_preciousness("coal", 4)
p4:scenario_ai_set_ware_preciousness("iron", 4)
p4:scenario_ai_set_ware_preciousness("iron_ore", 3)
p4:scenario_ai_set_ware_preciousness("gold", 6)
p4:scenario_ai_set_ware_preciousness("gold_ore", 5)
p4:scenario_ai_set_ware_preciousness("ax", 1)
p4:scenario_ai_set_ware_preciousness("ax_sharp", 3)
p4:scenario_ai_set_ware_preciousness("ax_broad", 2)
p4:scenario_ai_set_ware_preciousness("ax_bronze", 2)
p4:scenario_ai_set_ware_preciousness("ax_battle", 1)
p4:scenario_ai_set_ware_preciousness("ax_warriors", 1)
p4:scenario_ai_set_ware_preciousness("helmet", 2)
p4:scenario_ai_set_ware_preciousness("helmet_mask", 2)
p4:scenario_ai_set_ware_preciousness("helmet_warhelm", 1)

p4:scenario_ai_set_basic_economy("barbarians_fishers_hut", 2, 3)
p4:scenario_ai_set_basic_economy("barbarians_well", 1, 3)
p4:scenario_ai_set_basic_economy("barbarians_reed_yard", 1, 8)
p4:scenario_ai_set_basic_economy("barbarians_lime_kiln", 1, 8)
p4:scenario_ai_set_basic_economy("barbarians_wood_hardener", 2, 9)
...
p4:scenario_ai_set_basic_economy("barbarians_cattlefarm", 1, 1)
p4:scenario_ai_set_basic_economy("barbarians_helmsmithy", 1, 2)
p4:scenario_ai_set_basic_economy("barbarians_barracks", 1, 2)
...
-- =======================================================================
--                          NOCOM: OUTDATED!
--          Everything below will be deleted as soon as
--            it has been moved to src/ai/scenario_ai
-- =======================================================================
