...
local ai2 = p2.scenario_ai
local ai4 = p4.scenario_ai

ai2:set_militarysite_allowed("empire_sentry")
ai2:set_militarysite_allowed("empire_outpost")
ai2:set_militarysite_allowed("empire_tower")
ai2:set_militarysite_allowed("empire_barrier")
ai2:set_militarysite_allowed("empire_fortress")
ai2:set_militarysite_allowed("empire_castle")

ai2:set_trainingsite_allowed("empire_arena")
ai2:set_trainingsite_allowed("empire_colosseum")
ai2:set_trainingsite_allowed("empire_trainingcamp")

ai2:set_productionsite_allowed("empire_well")
ai2:set_productionsite_allowed("empire_fishers_house")
ai2:set_productionsite_allowed("empire_stonemasons_house")
ai2:set_productionsite_allowed("empire_sawmill")
ai2:set_productionsite_allowed("empire_mill")
ai2:set_productionsite_allowed("empire_bakery")
ai2:set_productionsite_allowed("empire_charcoal_kiln")
ai2:set_productionsite_allowed("empire_smelting_works")
ai2:set_productionsite_allowed("empire_toolsmithy")
ai2:set_productionsite_allowed("empire_armorsmithy")
ai2:set_productionsite_allowed("empire_barracks")
ai2:set_productionsite_allowed("empire_donkeyfarm")
ai2:set_productionsite_allowed("empire_farm")
ai2:set_productionsite_allowed("empire_piggery")
ai2:set_productionsite_allowed("empire_sheepfarm")
ai2:set_productionsite_allowed("empire_weaving_mill")
ai2:set_productionsite_allowed("empire_weaponsmithy")

ai2:set_warehouse_allowed("empire_warehouse")

ai2:set_is_enemy(1, true)
ai2:set_is_enemy(3, true)
ai2:set_is_enemy(4, false)
ai2.aggression_treshold = 1

ai2:set_ware_preciousness("granite", 1)
ai2:set_ware_preciousness("log", 1)
ai2:set_ware_preciousness("cloth", 1)
ai2:set_ware_preciousness("planks", 2)
ai2:set_ware_preciousness("marble", 2)
ai2:set_ware_preciousness("marble_column", 4)
ai2:set_ware_preciousness("fish", 1)
ai2:set_ware_preciousness("meat", 2)
ai2:set_ware_preciousness("water", 1)
ai2:set_ware_preciousness("wheat", 2)
ai2:set_ware_preciousness("flour", 1)
ai2:set_ware_preciousness("empire_bread", 2)
ai2:set_ware_preciousness("beer", 1)
ai2:set_ware_preciousness("coal", 4)
ai2:set_ware_preciousness("iron_ore", 3)
ai2:set_ware_preciousness("iron", 4)
ai2:set_ware_preciousness("gold_ore", 5)
ai2:set_ware_preciousness("gold", 6)
ai2:set_ware_preciousness("spear_wooden", 1)
ai2:set_ware_preciousness("spear", 2)
ai2:set_ware_preciousness("spear_advanced", 2)
ai2:set_ware_preciousness("spear_heavy", 1)
ai2:set_ware_preciousness("spear_war", 1)
ai2:set_ware_preciousness("armor_helmet", 1)
ai2:set_ware_preciousness("armor", 2)
ai2:set_ware_preciousness("armor_chain", 1)
ai2:set_ware_preciousness("armor_gilded", 1)

ai2:set_basic_economy("empire_fishers_house", 2, 3)
ai2:set_basic_economy("empire_well", 1, 3)
ai2:set_basic_economy("empire_stonemasons_house", 1, 8)
ai2:set_basic_economy("empire_sawmill", 2, 9)
ai2:set_basic_economy("empire_mill", 1, 4)
ai2:set_basic_economy("empire_bakery", 1, 4)
ai2:set_basic_economy("empire_charcoal_kiln", 3, 7)
ai2:set_basic_economy("empire_smelting_works", 2, 6)
ai2:set_basic_economy("empire_toolsmithy", 1, 5)
ai2:set_basic_economy("empire_armorsmithy", 1, 3)
ai2:set_basic_economy("empire_donkeyfarm", 1, 1)
ai2:set_basic_economy("empire_farm", 2, 4)
ai2:set_basic_economy("empire_sheepfarm", 1, 3)
ai2:set_basic_economy("empire_weaving_mill", 1, 3)
ai2:set_basic_economy("empire_weaponsmithy", 1, 2)
ai2:set_basic_economy("empire_barracks", 1, 2)
ai2:set_basic_economy("empire_trainingcamp", 1, 1)
ai2:set_basic_economy("empire_arena", 1, 1)
ai2:set_basic_economy("empire_outpost", 1, 7)
ai2:set_basic_economy("empire_sentry", 1, 4)

-- =======================================================================
--                                 Player 4
-- =======================================================================

ai4:set_militarysite_allowed("barbarians_sentry")
ai4:set_militarysite_allowed("barbarians_barrier")
ai4:set_militarysite_allowed("barbarians_tower")
ai4:set_militarysite_allowed("barbarians_fortress")
ai4:set_militarysite_allowed("barbarians_citadel")

ai4:set_warehouse_allowed("barbarians_warehouse")

ai4:set_trainingsite_allowed("barbarians_battlearena")
ai4:set_trainingsite_allowed("barbarians_trainingcamp")

ai4:set_productionsite_allowed("barbarians_well")
ai4:set_productionsite_allowed("barbarians_fishers_hut")
ai4:set_productionsite_allowed("barbarians_wood_hardener")
ai4:set_productionsite_allowed("barbarians_reed_yard")
ai4:set_productionsite_allowed("barbarians_lime_kiln")
ai4:set_productionsite_allowed("barbarians_bakery")
ai4:set_productionsite_allowed("barbarians_micro_brewery")
ai4:set_productionsite_allowed("barbarians_brewery")
ai4:set_productionsite_allowed("barbarians_charcoal_kiln")
ai4:set_productionsite_allowed("barbarians_smelting_works")
ai4:set_productionsite_allowed("barbarians_metal_workshop")
ai4:set_productionsite_allowed("barbarians_ax_workshop")
ai4:set_productionsite_allowed("barbarians_warmill")
ai4:set_productionsite_allowed("barbarians_barracks")
ai4:set_productionsite_allowed("barbarians_farm")
ai4:set_productionsite_allowed("barbarians_helmsmithy")
ai4:set_productionsite_allowed("barbarians_cattlefarm")

ai4:set_is_enemy(1, true)
ai4:set_is_enemy(3, true)
ai4:set_is_enemy(2, false)
ai4.aggression_treshold = -1

ai4:set_ware_preciousness("log", 1)
ai4:set_ware_preciousness("granite", 1)
ai4:set_ware_preciousness("blackwood", 3)
ai4:set_ware_preciousness("grout", 3)
ai4:set_ware_preciousness("thatch_reed", 1)
ai4:set_ware_preciousness("fish", 1)
ai4:set_ware_preciousness("water", 1)
ai4:set_ware_preciousness("wheat", 2)
ai4:set_ware_preciousness("barbarians_bread", 3)
ai4:set_ware_preciousness("beer_strong", 1)
ai4:set_ware_preciousness("coal", 4)
ai4:set_ware_preciousness("iron", 4)
ai4:set_ware_preciousness("iron_ore", 3)
ai4:set_ware_preciousness("gold", 6)
ai4:set_ware_preciousness("gold_ore", 5)
ai4:set_ware_preciousness("ax", 1)
ai4:set_ware_preciousness("ax_sharp", 3)
ai4:set_ware_preciousness("ax_broad", 2)
ai4:set_ware_preciousness("ax_bronze", 2)
ai4:set_ware_preciousness("ax_battle", 1)
ai4:set_ware_preciousness("ax_warriors", 1)
ai4:set_ware_preciousness("helmet", 2)
ai4:set_ware_preciousness("helmet_mask", 2)
ai4:set_ware_preciousness("helmet_warhelm", 1)

ai4:set_basic_economy("barbarians_fishers_hut", 2, 3)
ai4:set_basic_economy("barbarians_well", 1, 3)
ai4:set_basic_economy("barbarians_reed_yard", 1, 8)
ai4:set_basic_economy("barbarians_lime_kiln", 1, 8)
ai4:set_basic_economy("barbarians_wood_hardener", 2, 9)
ai4:set_basic_economy("barbarians_charcoal_kiln", 3, 7)
ai4:set_basic_economy("barbarians_bakery", 1, 4)
ai4:set_basic_economy("barbarians_micro_brewery", 1, 3)
ai4:set_basic_economy("barbarians_brewery", 1, 3)
ai4:set_basic_economy("barbarians_smelting_works", 2, 6)
ai4:set_basic_economy("barbarians_metal_workshop", 2, 5)
ai4:set_basic_economy("barbarians_farm", 2, 4)
ai4:set_basic_economy("barbarians_cattlefarm", 1, 1)
ai4:set_basic_economy("barbarians_helmsmithy", 1, 2)
ai4:set_basic_economy("barbarians_barracks", 1, 2)
ai4:set_basic_economy("barbarians_battlearena", 1, 2)
ai4:set_basic_economy("barbarians_trainingcamp", 1, 1)
ai4:set_basic_economy("barbarians_barrier", 1, 5)

ai2.think_interval = 490
ai4.think_interval = 510
